<?php include('partials-front/menu.php');?>
    ...
    <section class="categories">
        <div class="container">
            <h2 class="text-center">Explore Vegetable-Fruits</h2>
    ...
    <section class="food-menu">
        <div class="container">
            ...
            <?php
               ...
               $sql2="SELECT * FROM tbl_vegetable WHERE active='Yes' AND featured='Yes' LIMIT 20";
               ...
               //execute the query
                ...
                {
                    //Food not Available
                    echo "<div class='error'>Vegetable/Fruit Not Available</div>";
                }
        ...
        <p class="text-center">
            <a href="#">See All Vegetable-Fruits</a>
        </p>
    </section>
